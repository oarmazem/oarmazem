...
try {
  ...
  if (isset($_POST['update'])) {
    ...
    if (isset($_POST['delete'])) {
      ...
      $update->writeFormOnDatabase();

    }

  }//if

  $update->writeDatabaseOnForm($cod);//Le os dados do artigo no BD
...
<body>
  ...
  <form method="POST" action="update.php" onsubmit="return validateFormUpdate(this)">
    ...
    <fieldset><!--Formulario-->  
      ...
      <input type="hidden" name="next_img_index" value="<?php echo $update->nextImgIndex ?>">
